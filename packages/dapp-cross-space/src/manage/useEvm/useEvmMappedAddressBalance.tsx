...
const EvmMappedAddressBalanceContext = createContext<string | undefined>(undefined);
...
const useEvmMappedAddressBalance = () => useContext(EvmMappedAddressBalanceContext);
