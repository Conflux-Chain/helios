(ns cfxjs.db.datascript.serialize
  (:refer-clojure :exclude [amap array?])
  (:require
   [clojure.edn :as edn]
   [clojure.string :as str]
   [cfxjs.db.datascript.db :as db #?(:cljs :refer-macros :clj :refer) [raise cond+] #?@(:cljs [:refer [Datom]])]
   [cfxjs.db.datascript.lru :as lru]
   [me.tonsky.persistent-sorted-set :as set]
   [me.tonsky.persistent-sorted-set.arrays :as arrays])
  #?(:cljs (:require-macros [cfxjs.db.datascript.serialize :refer [array dict]]))
  #?(:clj
     (:import
