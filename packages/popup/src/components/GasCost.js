...
function GasCost({sendParams, networkTypeIsCfx, displayFee}) {
  ...
  const feeBalance = displayFee ? displayFee.balance : realPayedFeeDrip
  const feeSymbol = displayFee ? displayFee.symbol : symbol
  const feeDecimals = displayFee ? displayFee.decimals : decimals
