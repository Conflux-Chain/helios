const fr = {
  translation: {
    ...
    maxPriorityFeePerGasHighErr:
      'Valeur tapée <= "Frais Max Par Gas" est requise',
    ...
    hardwareAccountTips:
      'Le(s) compte(s) ajouté(s) est disponible sur {{chain}}',
    ready: 'Prêt',
    ...
    openLedgerAppDes:
      'Sélectionner et ouvrir l’App {{appName}} sur votre dispositif Ledger.',
