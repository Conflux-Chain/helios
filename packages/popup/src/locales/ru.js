const ru = {
  translation: {
    ...
    permitSignatureAuthorization: 'Авторизация подписи',
    permitSpendingCap: 'Лимит расходов',
    permitSpender: 'Спендер',
    permitTooltipTitle: 'Что такое Permit',
    permitTooltipDescription:
      'Подпись разрешения вне сети. После подписи спендер сможет использовать ваши токены в пределах лимита до истечения срока действия — без предварительной транзакции approve и комиссии за газ.',
    permitSpenderTooltip:
      'Контракт или адрес, которому разрешено перемещать токены из вашего кошелька. После подтверждения он сможет использовать ваши токены в пределах лимита расходов. Это не передает право собственности, но злоумышленник может вывести разрешенные токены — проверьте адрес перед подтверждением.',
    ...
    eip7702SponsoredDescription:
      'Эта транзакция подходит для спонсорской оплаты газа. После обновления аккаунт получит следующие интеллектуальные функции. Вы можете отозвать это разрешение в любое время в настройках.',
    eip7702SponsoredBenefitsTitle: 'Получите больше преимуществ',
    eip7702SponsoredGasFreeDapps:
      'Транзакции без оплаты газа в поддерживаемых dApp',
    eip7702SponsoredFlexibleGas: 'Гибкая оплата газа',
    eip7702SponsoredBatchTransactions: 'Объединение нескольких транзакций',
    eip7702SponsoredUpgradeConfirm: 'Включить и продолжить',
    eip7702SponsoredSwitchTitle: 'Переключиться на сервис EIP-7702',
    eip7702SponsoredSwitchConfirm: 'Переключиться и продолжить',
    ...
    closeSidePanel: 'Открыть во всплывающем окне',
