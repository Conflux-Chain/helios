const uk = {
  translation: {
    ...
    gasFee: 'Плата за газ',
    gasPayFeeTooltip:
      'Ця комісія сплачується мережі за обробку вашої транзакції. Якщо ви виберете оплату газу не нативним токеном, Fluent стягне сервісну комісію за конвертацію.',
    selectToken: 'Виберіть токен',
    payWithNativeToken: 'Оплатити нативним токеном',
    payWithOtherTokens: 'Оплатити іншими токенами',
    ...
    eip7702SwitchInfoDesc:
      'Цей обліковий запис наразі прив’язаний до стороннього контракту. Перейдіть на Fluent Wallet для кращого досвіду.',
    eip7702SwitchInfoBenefitsTitle: 'Отримайте більше можливостей',
    eip7702SwitchInfoConfirm: 'Перейти та продовжити',
